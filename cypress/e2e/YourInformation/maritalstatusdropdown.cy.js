describe('Marital status section', () => {
    ...
    it('should select "Single" when the letter "S" is entered', () => {
    ...
    it('should display "Partnered" when selected', () => {
